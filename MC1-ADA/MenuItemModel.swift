...
class MenuItemModel{
    ...
    var mainMenu = [
        MenuItem(destination: ToDoView(), title: "Meditation", icon: "brain.head.profile", stopsArray: [
        ...
        MenuItem(destination: ToDoView(), title: "Relaxation", icon: "wind", stopsArray: [
            Gradient.Stop(color: Color(red: 0.65, green: 0.81, blue: 0.84).opacity(0.7), location: 0.00),
            Gradient.Stop(color: Color(red: 0.95, green: 0.93, blue: 0.87), location: 0.79),
        ]),
        MenuItem(destination: ToDoView(), title: "Sort It Out", icon: "list.clipboard", stopsArray: [
